...
public class Janela1 implements ActionListener{
	...
	public static void criaJan(){
		...
		jan1.setExtendedState(jan1.MAXIMIZED_BOTH);
		//jan1.setExtendedState(jan1.ICONIFIED | jan1.MAXIMIZED_BOTH);
		//jan1.setExtendedState(jan1.NORMAL);
		//jan1.setExtendedState(jan1.MAXIMIZED_HORIZ);
		//jan1.setExtendedState(jan1.MAXIMIZED_VERT);
		
		int x = jan1.getExtendedState();
